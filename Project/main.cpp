...
public:
    ...
    // Load all customers
    static vector<Customer> loadAll()
    {
        ...
        while (file.peek() != EOF)
        {
            ...
            int orderSize;
            file.read(reinterpret_cast<char *>(&orderSize), sizeof(orderSize));
            cust.orders.clear();
            for (int i = 0; i < orderSize; i++)
            {
                pair<int, int> p;
                file.read(reinterpret_cast<char *>(&p), sizeof(p));
                cust.orders.push_back(p);
            }
...
void thanksMessage(Customer &cust)
{
...
void customerInterface(void)
{
    ...
    while (true)
    {
        ...
        cout << BOLD PURPLE "1. " END ITALIC GREEN "Show Available seat \n";
        cout << BOLD PURPLE "2. " END ITALIC GREEN "Booking a Seat \n";
        cout << BOLD PURPLE "3. " END ITALIC GREEN "View Available Item\n";
        cout << BOLD PURPLE "4. " END ITALIC GREEN "Order Item \n";
        cout << BOLD PURPLE "5. " END ITALIC GREEN "Order from the Menu Card\n";
        ...
        case '2':
            loading();
            int t, s;
            cout << BOLD ITALIC "Enter table number: " END;
            cin >> t;
            cout << BOLD ITALIC "Enter seat number: " END;
            cin >> s;
            if (bookSeat(cust, t, s))
            {
                cout << GREEN "Seat booked successfully!\n" END;
            ...
            {
                cout << RED "Seat is already booked or invalid. Try again.\n" END;
                this_thread::sleep_for(chrono::milliseconds(1500));
                system("clear");
            }
...
int main()
{
    ...
    vector<Customer> customers = Customer::loadAll();
    Customer::customerCount = customers.size();
